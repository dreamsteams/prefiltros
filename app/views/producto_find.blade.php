              ...
              <div class="modal-body">
                 <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="row">
                        <div class="col-md-6">
                          <h5 class="text-center"><b>Nombre del producto</b></h5>
                        </div>
                        <div class="col-md-6">
                          <h5 class="text-center"><b>Descripción del producto</b></h5>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
...
<section id="productos"  style="margin-top:5%;padding-left:3%;padding-right:3%;">
  <div class="row">
  ...
  <div class="row" id="row-pagination">
    <div class="col-md-12">
      <ul class="pagination">
        <li class="page-item disabled prev"><a class="page-link" href = "#" data-toggle="tooltip" data-placement="bottom" title="Anterior">&laquo;</a></li>
          <?php $contador=1; $n=1; $productos = $resultados;?>
    ...
    <div class="row row-void" hidden>
      <div class="col-md-12 col-xs-12 col-sm-12">
        <h1 class="text-void text-center">No se ha encontrado ningun producto.</h1>
      </div>
    </div>
  ...
  <?php $contador_page=0;$contador_row=1;$n=1;?>
    @foreach($resultados as $producto)
      ...
      @endif
        @if(Auth::user())
          @if($resultados[0]->id ==$producto->id)
          <div class="col-md-2">
            <div class="card card-dark card-new"  data-toggle="modal" data-target="#modal-upload-product" data-placement="bottom" title="Agregar nuevo producto">
        ...
        @endif
        <div class="col-md-2">
          <div class="card card-product" data-descripcion="{{$producto->descripcion}}" data-titulo="{{$producto->titulo}}" data-card-id="{{$producto->id}}" data-imagen="{{$producto->imgMarca}}" data-marca="{{$producto->nombreMarca}}">
...
@section('js')
{{HTML::script('/packages/js/prefiltros/productos_find.js')}}
@stop